...
import frc.lib.pathplanner.com.pathplanner.lib.PathPlannerTrajectory.StopEvent;
import frc.lib.pathplanner.com.pathplanner.lib.PathPlannerTrajectory.StopEvent.ExecutionBehavior;
import frc.lib.pathplanner.com.pathplanner.lib.commands.FollowPathWithEvents;
    ...
    public CommandBase resetPose(PathPlannerTrajectory trajectory) {
        if (drivetrainType == DrivetrainType.HOLONOMIC) {
            return Commands.runOnce(() -> {
                ...
                LightningShuffleboard.setDouble("Autonomous", "holonomicRotation",
