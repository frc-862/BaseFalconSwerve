...
import frc.lib.pathplanner.org.json.simple.JSONArray;
import frc.lib.pathplanner.org.json.simple.JSONObject;
import frc.lib.pathplanner.org.json.simple.parser.JSONParser;
...
public class PathPlanner {
        ...
        if (w.isStopPoint || i == waypoints.size() - 1) {
          ...
          for (EventMarker marker : markers) {
            if (marker.waypointRelativePos >= waypoints.indexOf(currentPath.get(0))
              ...
              currentMarkers.add(new EventMarker(marker.names,
  ...
  public static PathPlannerTrajectory generatePath(PathConstraints constraints, boolean reversed,
      List<PathPoint> points, List<EventMarker> eventMarkers) {
    if (points.size() < 2) {
   ...
   */
  @Deprecated
  public static PathPlannerTrajectory generatePath(double maxVel, double maxAccel, boolean reversed,
      List<PathPoint> points) {
  ...
  public static PathPlannerTrajectory generatePath(PathConstraints constraints,
      List<PathPoint> points, List<EventMarker> markers) {
  ...
  public static PathPlannerTrajectory generatePath(PathConstraints constraints, boolean reversed,
      List<EventMarker> markers, PathPoint point1, PathPoint point2, PathPoint... points) {
    List<PathPoint> pointsList = new ArrayList<>();
    pointsList.add(point1);
    pointsList.add(point2);
    pointsList.addAll(List.of(points));
   ...
   */
  @Deprecated
  public static PathPlannerTrajectory generatePath(double maxVel, double maxAccel, PathPoint point1,
      PathPoint point2, PathPoint... points) {
  ...
  private static List<Waypoint> getWaypointsFromJson(JSONObject json) {
    ...
    for (Object waypoint : jsonWaypoints) {
      ...
      Translation2d anchorPoint = new Translation2d(((Number) jsonAnchor.get("x")).doubleValue(),
      ...
      waypoints.add(new Waypoint(anchorPoint, prevControl, nextControl, velOverride, holonomicAngle,
          isReversal, isStopPoint, stopEvent));
    }
