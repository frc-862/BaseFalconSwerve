...
import frc.lib.shuffleboard.LightningShuffleboard;
...
public class PPSwerveControllerCommand extends CommandBase {
    ...
    public PPSwerveControllerCommand(PathPlannerTrajectory trajectory,
            ...
            Consumer<ChassisSpeeds> outputChassisSpeeds, boolean useAllianceColor,
            Subsystem... requirements) {
        this.trajectory = trajectory;
        this.poseSupplier = poseSupplier;
        this.controller = new PPHolonomicDriveController(xController, yController,
                rotationController, poseController);
        ...
        LightningShuffleboard.setDoubleSupplier("Autonomous", "auto target pose x",
                () -> desiredState.poseMeters.getX());
        LightningShuffleboard.setDoubleSupplier("Autonomous", "auto target pose Y",
                () -> desiredState.poseMeters.getY());
        LightningShuffleboard.setDoubleSupplier("Autonomous", "auto target holonomic rotation",
                () -> desiredState.holonomicRotation.getDegrees());
        LightningShuffleboard.setDoubleSupplier("Autonomous", "auto target velocity",
    ...
    public PPSwerveControllerCommand(PathPlannerTrajectory trajectory,
            Supplier<Pose2d> poseSupplier, PIDController xController, PIDController yController,
            PIDController rotationController, PIDController poseController,
            Consumer<ChassisSpeeds> outputChassisSpeeds, Subsystem... requirements) {
    ...
    public PPSwerveControllerCommand(PathPlannerTrajectory trajectory,
            ...
            PIDController poseController, Consumer<SwerveModuleState[]> outputModuleStates,
    ...
    public PPSwerveControllerCommand(PathPlannerTrajectory trajectory,
        ...
        this(trajectory, poseSupplier, kinematics, xController, yController, rotationController,
                poseController, outputModuleStates, false, requirements);
    }
